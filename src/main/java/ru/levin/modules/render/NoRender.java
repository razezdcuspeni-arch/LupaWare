...
public class NoRender extends Function {
    public MultiSetting mods = new MultiSetting(
            "Убрать",
            Arrays.asList("Тряска камеры", "Огонь на экране", "Вода на экране", "Удушье", "Скорборд", "Плохие эффекты", "Тьма"),
            new String[]{"Тряска камеры", "Огонь на экране", "Вода на экране", "Удушье", "Скорборд", "Плохие эффекты", "Тьма"}
    );
